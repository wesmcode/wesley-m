...
export const CASES: Record<string, CaseStudy> = {
  ...
  "political-media-ecosystem": {
    "title": "\"Modernize the site\" became a measurable roadmap protecting 65M monthly views",
    "eyebrow": "Case study 03 &middot; [NDA Client] &middot; US political media network",
    "pillar": "Platform modernization",
    "tagline": "Modernization without measurement could destroy audience value. The brief was vague. The risk was specific: 65M+ views, 65/100 domain authority, 16 properties, and an editorial process the audience depended on.",
    "tags": [
  ...
  "retail-ecommerce-modernisation": {
    ...
    "pillar": "Retention and growth",
    "tagline": "The demand existed. The platform was not ready to convert it. Checkout friction, no modern payments, fragile peak capacity. The modernization had to land before holiday season or the biggest e-commerce window in retail history would pass.",
    "tags": [
